...
输出：10_relaxed_instruments.tsv
"""
import csv, glob, os, subprocess, collections, sys

MR   = r"D:/R_ex/MR"
ESD  = os.path.join(MR, "esd")
TMP  = os.path.join(MR, "clump_tmp")
PLINK= os.path.join(MR, "bin", "plink2.exe")
BFILE= os.path.join(MR, "ref", "1kg_eur")
...
with open(os.path.join(MR, "10_relaxed_instruments.tsv"), "w",
